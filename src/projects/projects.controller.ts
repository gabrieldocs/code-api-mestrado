...
export class ProjectsController {
  ...
  async folder_structure(@Query('folder_path') folder_path: string) {
    return this.projectsService.folder_structure(folder_path);
  }

  async getFolderStructure(folderPath: string): Promise<any> {
    return this.projectsService.get_folder_structure(folderPath);
  }
